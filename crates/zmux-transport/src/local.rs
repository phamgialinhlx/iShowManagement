...
//!
//! This is what makes zmux a normal IDE when you are not connected to anything.
...
///
/// **On Windows this looks for bash before falling back to `COMSPEC`.** zmux
...
pub fn terminal_env() -> BTreeMap<String, String> {
    ...
    env.insert("TERM_PROGRAM".to_owned(), "zmux".to_owned());
    env
}
