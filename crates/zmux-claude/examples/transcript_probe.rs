//! Prints the tail of a folder's newest Claude transcript, as zmux parses it.
use zmux_claude::transcript;
...
async fn main() -> anyhow::Result<()> {
    ...
    let target = zmux_ssh::SshTarget::new(zmux_transport::SshHostId::new(&host));
