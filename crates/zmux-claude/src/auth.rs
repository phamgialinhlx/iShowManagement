...
//! practical, which is every remote host zmux talks to.
//!
//! zmux runs it in a PTY, spots the URL it prints, opens that in the *local*
...
//! `zmuxd::protocol::Frame::SetEnv` — and the daemon keeps it in memory only.
...
/// What kind of credential zmux was handed.
///
