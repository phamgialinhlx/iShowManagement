...
//! persistence) per ADR-0002. A leaf is a `Pane` (a tab strip of terminals);
//! the tree arranges leaves along horizontal/vertical axes and supports
//! drag-to-resize.
//!
//! What was dropped vs. the upstream `pane_group.rs`: the `Project`-aware
//! `Item` model, the collaboration `PaneLeaderDecorator`/follower path,
