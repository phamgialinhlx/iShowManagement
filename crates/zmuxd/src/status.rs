...
//! ## Why this exists
//!
//! zmux used to learn "is this session working?" by polling the terminal screen
//! several times a second **per pane** and parsing it (`zmux_claude::parse_state`).
...
//!
//! Fields are picked out one at a time, exactly like `zmux_claude::transcript` —
