//! The zmux side of the askpass bridge.
//!
...
//!    connect and phish a password dialog out of zmux.
...
mod tests {
    ...
    async fn a_request_without_the_token_gets_nothing() {
        // Any local process could otherwise phish a credential dialog out of zmux
